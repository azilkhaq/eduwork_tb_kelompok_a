        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="gallery-item mb-4 rounded overflow-hidden">
                        ...
                        <div class="gallery-content">
                            ...
                            <ul>
                                <li><a href="assets/images/trending/trending2.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
                                <li><a href="destination_detail.php"><i class="fa fa-link"></i></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="gallery-item mb-4 rounded overflow-hidden">
                        ...
                        <div class="gallery-content">
                            ...
                            <ul>
                                <li><a href="assets/images/trending/trending3.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
                                <li><a href="destination_detail.php"><i class="fa fa-link"></i></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="gallery-item mb-4 rounded overflow-hidden">
                        ...
                        <div class="gallery-content">
                            ...
                            <ul>
                                <li><a href="assets/images/trending/trending4.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
                                <li><a href="destination_detail.php"><i class="fa fa-link"></i></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="gallery-item mb-4 rounded overflow-hidden">
                        <div class="gallery-image">
                            <img src="assets/images/trending/trending8.jpg" alt="image">
                        </div>
                        <div class="gallery-content">
                            <h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">FLorida - USA</h5>
                            <ul>
                                <li><a href="assets/images/trending/trending5.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
                                <li><a href="destination_detail.php"><i class="fa fa-link"></i></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="gallery-item mb-4 rounded overflow-hidden">
                        ...
                        <div class="gallery-content">
                            ...
                            <ul>
                                <li><a href="assets/images/trending/trending6.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
                                <li><a href="destination_detail.php"><i class="fa fa-link"></i></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="gallery-item mb-4 rounded overflow-hidden">
                        ...
                        <div class="gallery-content">
                            ...
                            <ul>
                                <li><a href="assets/images/trending/trending7.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
                                <li><a href="destination_detail.php"><i class="fa fa-link"></i></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="gallery-item mb-4 rounded overflow-hidden">
                        <div class="gallery-image">
                            <img src="assets/images/destination/destination6.jpg" alt="image">
                        </div>
                        <div class="gallery-content">
                            <h5 class="white text-center position-absolute bottom-0 pb-4 left-50 mb-0 w-100">Bangkok - Thailand</h5>
                            <ul>
                                <li><a href="assets/images/trending/trending8.jpg" data-lightbox="gallery" data-title="Title"><i class="fa fa-eye"></i></a></li>
                                <li><a href="destination_detail.php"><i class="fa fa-link"></i></a></li>
                            </ul>
                        </div>
                    </div>
