                            ...
                            <div class="trend-content p-4 pt-5 position-relative">
                                <div class="trend-meta bg-theme white px-3 py-2 rounded">
                                    <div class="entry-author">
                                        ...
                                        <span class="fw-bold">Wisata Sejarah</span>
                                    </div>
                                </div>
                                <h3 class="mb-1"><a href="tour-grid.html">Borobudur - Yogyakarta</a></h3>
                        ...
                        <div class="trend-item rounded box-shadow">
                            ...
                            <div class="trend-content p-4 pt-5 position-relative">
                                <div class="trend-meta bg-theme white px-3 py-2 rounded">
                                    <div class="entry-author">
                                        <i class="icon-calendar"></i>
                                        <span class="fw-bold">Wisata Kuliner</span>
                                    </div>
                                </div>
                                <h3 class="mb-1"><a href="tour-grid.html">Pasar Lama - Tangerang</a></h3>
                                <div class="rating-main d-flex align-items-center pb-2">
                                    <div class="rating">
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                        ...
                        <div class="trend-item rounded box-shadow">
                            ...
                            <div class="trend-content p-4 pt-5 position-relative">
                                <div class="trend-meta bg-theme white px-3 py-2 rounded">
                                    <div class="entry-author">
                                        <i class="icon-calendar"></i>
                                        <span class="fw-bold">Wisata Budaya</span>
                                    </div>
                                </div>
                                <h3 class="mb-1"><a href="tour-grid.html">Istana Tirta Gangga - Bali</a></h3>
                                <div class="rating-main d-flex align-items-center pb-2">
                                    <div class="rating">
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
