...
<body>
    ...
    <section class="about-us pb-0">
        <div class="section-shape section-shape1" style="background-image: url(assets/images/shape8.png);"></div>
        <div class="container">
    ...
    <!-- testomonial start -->
    <section class="testimonial pt-9" style="background-image:url(assets/assets/images/testimonial.png)">
        <div class="container">
